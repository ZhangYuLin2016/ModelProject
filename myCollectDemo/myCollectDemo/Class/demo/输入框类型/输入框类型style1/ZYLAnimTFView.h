...
typedef NS_ENUM(NSUInteger, ZYLAnimTextFieldState) {
    ZYLAnimTextFieldStateNormal = 0,
    ZYLAnimTextFieldStateEditing,
    ZYLAnimTextFieldStateError,
};

typedef NS_ENUM(NSUInteger, ZYLAnimTextFieldInputType) {
    ZYLAnimTextFieldInputTypeDefault = UIKeyboardTypeDefault,
    ZYLAnimTextFieldInputTypePassword,
    ZYLAnimTextFieldInputTypeTips,
};

@interface ZYLAnimTFView : UIView<CAAnimationDelegate>
...
@property (nonatomic, assign) ZYLAnimTextFieldState state;

/** textFiled输入类型 默认XMNAnimTextFieldInputTypeDefault=UIKeyboardTypeDefault */
@property (nonatomic, assign) ZYLAnimTextFieldInputType inputType;
